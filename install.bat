...
if %errorlevel% neq 0 (
    ...
    start "" "pythonw" "%USERPROFILE%\screenclip_autosave\main.py"
)
...
echo start "" "pythonw" "%USERPROFILE%\screenclip_autosave\main.py" > "%USERPROFILE%\screenclip_autosave\screenclip_autosave_start.bat"
